...
@dso_cache = dso_local local_unnamed_addr global [618 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 822325670, ; hash 0x3103b1a6, from name: libaot-bamauiapp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1515727949, ; hash 0x5a582c4d, from name: aot-bamauiapp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-bamauiapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 214
	...
	%struct.DSOCacheEntry {
		i64 1630715397, ; hash 0x6132be05, from name: bamauiapp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-bamauiapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 221
	...
	%struct.DSOCacheEntry {
		i64 2686940926, ; hash 0xa02776fe, from name: libaot-bamauiapp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-bamauiapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 396
	...
	%struct.DSOCacheEntry {
		i64 3468262514, ; hash 0xceb97c72, from name: bamauiapp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-bamauiapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 508
	...
	%struct.DSOCacheEntry {
		i64 4109796538, ; hash 0xf4f684ba, from name: aot-bamauiapp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-bamauiapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 589
